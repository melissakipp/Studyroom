...
passed to this method and return that value as string in format "XXh YYm ZZs" where XX represents a
...
public class SecondsAndMinutes {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDurationString(45,45));
        System.out.println(getDurationString(75,10));
    ...
    private static String getDurationString(long minutes, long seconds) {
        ...
        String result = (minutes / 60 < 10 ? "0" : "") + minutes/60 + "h ";
        result += (minutes % 60 < 10 ? "0" : "") + (minutes % 60) + "m ";
        result += (seconds < 10 ? "0" : "") + seconds + "s";

        return (minutes < 0 || seconds < 0 || seconds > 59) ? "Invalid value" : result;

...
import static com.examples.exercises.section_4.TeenNumberCheck.hasTeen;
import static com.examples.exercises.section_4.TeenNumberCheck.isTeen;

public class TeenNumberCheck {

    public static boolean isTeen(int teen) {

        final boolean b = teen >= 13 && teen <= 19;
        return b;
...
class TeenNumberCheckTestDriver {

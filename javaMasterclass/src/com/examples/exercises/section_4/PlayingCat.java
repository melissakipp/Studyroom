...
import static com.examples.exercises.section_4.PlayingCat.isCatPlaying;
...
/*    public static boolean isCatPlaying(boolean summer, int temperature) {
    ...
    public static boolean isCatPlaying(boolean summer, int temperature) {
        return (temperature >= TWENTY_FIVE && temperature <= THIRTY_FIVE) || ((temperature >= 25 && temperature <= FORTY_FIVE) && summer);
    }
}

class PlayingCatTestDrive {
